        ...
        <>
            ...
            <div className='grid grid-cols-3 gap-2 overflow-y-auto px-8 py-1 h-[90px] scrollbar-hide -mt-6'>
                <div
                    ...
                    onClick={() => setScreen({ level: screen.level == 2? 2:3, page: "DEVICE_LIST" })}
                >
                    <h5>Events</h5>
                </div>
                <div
                    className="cursor-pointer rounded bg-[#658602FF] px-2 py-1 text-center font-bold text-[#324200FF] transition duration-200 hover:bg-green-800 hover:text-[#A0BD49FF]"
                    onClick={() => setScreen({ level: screen.level == 2? 2:3, page: "ZONE_INFO" })}
                >
                    <h5>Zones</h5>
                </div>
                <div
                    className="cursor-pointer rounded bg-[#658602FF] px-2 py-1 text-center font-bold text-[#324200FF] transition duration-200 hover:bg-green-800 hover:text-[#A0BD49FF]"
                    onClick={() => setScreen({ level: screen.level == 2? 2:3, page: "PANEL_INFO" })}
                >
                    <h5>Test</h5>
                </div>
                <div
                    className="cursor-pointer rounded bg-[#658602FF] px-2 py-1 text-center font-bold text-[#324200FF] transition duration-200 hover:bg-green-800 hover:text-[#A0BD49FF]"
                    onClick={() => setScreen({ level: screen.level == 2? 2:3, page: "EXPANDER_LIST" })}
                >
                    <h5>Input Prog</h5>
                </div>
                <div
